...
LIVE_FEED_INFERENCE_ACC_THRESHOLD = float(os.getenv("LIVE_FEED_INFERENCE_ACC_THRESHOLD",1.1))
LIVE_FEED_SPECTROGRAM_WINDOW_SECONDS = 2
NOTIFICATION_PROBABILITY_TRESHOLD_DUMMY = float(os.getenv("NOTIFICATION_PROBABILITY_TRESHOLD_DUMMY",0.5))
NOTIFICATION_PROBABILITY_TRESHOLD_OBJECT = float(os.getenv("NOTIFICATION_PROBABILITY_TRESHOLD_OBJECT",0.5))
ACC_SKIP_X_SECONDS_AFTER_TRIGGER=5
